...
def make_submission_quality_image(image_type, traces, hw_cfg):
    ...
    png_layout.xaxis.title = {"text": layout.xaxis.title.text, "font": {"size": TEXT_SIZE, "color": "black"}}
    ...
    png_layout.yaxis.title = {"text": layout.yaxis.title.text, "font": {"size": TEXT_SIZE, "color": "black"}}
...
for cfg, sim_for_cfg in sim_data.items():
    ...
    if hw_cfg == None:
        ...
        continue
    print("Correlation List:", correl_list)
...
print("fig_data contents:", fig_data)
